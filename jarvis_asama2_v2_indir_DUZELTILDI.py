...
def asama2_prompt(
    ...
    if step == "helper_add":
        ...
        adim = (
            ...
            "- Hedef dosya kesinlikle test_jarvis_sessiz.py.\n"
...
def asama2_step_tamam_mi(workspace, spec, step):
    ...
    kaynak = dosya_oku(
        workspace / "test_jarvis_sessiz.py"
    )

    return spec["action"] in kaynak
...
def asama2_rapor(
    ...
    rapor = {
        ...
        "stage": 2,
        "architecture":
            "stage1_engine_three_step_capability",
        "model":
            ASAMA2_MODEL,
        "agent":
            ASAMA2_AGENT,
...
def asama2_step(
    ...
    # Bu esneklik assistant_integration icin uygulanmaz; o adim hala yalnizca
    # gosterilen context icinden patch yapabilir.
...
def asama2_main():
    ...
    durum(
        ...
        (
            ...
            "yetenekler helper_add -> route_add -> assistant_integration olarak bolundu."
        )
    )
